...
export const ContactPageClient = () => {
  ...
  const labelClass =
    "block text-xs font-semibold text-muted-lavender/70 uppercase tracking-widest mb-2";
          ...
          <Container size="lg" className="relative z-10 text-center">
            ...
            >
              ...
              <p className="text-lg text-warm-beige/60 max-w-xl mx-auto leading-relaxed">
                Tell us about your AI, SaaS, or MVP project. We read every message
            ...
            <div className="flex flex-wrap justify-center md:justify-between items-center gap-8">
              {[
                ...
                <div key={label} className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs text-muted-lavender/60 uppercase tracking-widest">
                      {label}
                    </p>
                    {href ? (
                      <a
                        href={href}
                        className="text-sm font-semibold text-warm-beige hover:text-rich-purple transition-colors"
                      >
                        {value}
                      </a>
                    ) : (
                      <p className="text-sm font-semibold text-warm-beige">
                        {value}
                      </p>
                    )}
                  </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
              ...
              >
                ...
                <p className="text-warm-beige/55 mb-10 text-sm leading-relaxed">
                  Prefer to write it out? Fill in the form and we&apos;ll get back
                ...
                {submitted ? (
                  ...
                  >
                    ...
                    <h3 className="text-xl font-display font-bold text-warm-beige mb-2">
                      Message Received!
                    </h3>
                    <p className="text-warm-beige/60 text-sm">
                      We&apos;ll review your brief and reach out within 24 hours.
                      In the meantime, feel free to book a call below.
                    </p>
                  </motion.div>
                ) : (
              ...
              >
                ...
                <p className="text-warm-beige/55 mb-10 text-sm leading-relaxed">
                  Prefer to talk? Grab a free 30-minute strategy session at a time
                  that works for you.
                </p>
